  ...
  return (
    <div className="container pt-5">
      <div className="text-center mb-5">
        <h1 className="fw-bold text-primary"><img
        alt="Loading..."
        className="rotate-clockwise img-fluid"
        src="../src/assets/images/logo.png"
        style={{ maxWidth: "80px", height: "auto" }}
      />
      Welcome to Machine Coding Questions</h1>
      ...
      <div className="mt-5 text-center">
        ...
        <div className="alert alert-primary d-flex align-items-center gap-2 p-3 mt-4 shadow-sm" role="alert">
  
  <div>
    <strong>Want to connect with me? </strong>
    Learn more about my work, projects, and journey by{" "}
    <a
